/**
 * 🏗️ Lexipop Memory NFT Contract Interface
 *
 * Contract ABI and utilities for interacting with the NFT contract
 */

export const LEXIPOP_NFT_ABI = [
  {
    inputs: [],
...
export function getContractAddress(chainId: number): string {
  const address = CONTRACT_ADDRESSES[chainId as ContractNetwork];
  if (!address) {
